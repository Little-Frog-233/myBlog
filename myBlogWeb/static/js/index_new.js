...
var _require = __webpack_require__(1),
    getUserMessage = _require.getUserMessage,
    GetQueryValue = _require.GetQueryValue,
    slowScroll = _require.slowScroll;
...
var app = new _vue2.default({
    ...
    methods: {
        ...
        getCategoryClass: function getCategoryClass(item) {
            return { 'layui-this': item == this.now_category };
        },
        getTagClass: function getTagClass(item) {
        ...
        changeNowCategory: function changeNowCategory(item) {
        ...
        changeNowTag: function changeNowTag(item) {
            this.now_tag = item;
            this.more = true;
            this.start = 0;
            this.getBlogList();
        ...
        getContent: function getContent(content) {
            ...
            if (content.length > max_length) {
                var c_1 = content.substr(0, max_length);
                content = c_1 + '...';
                return content;
            } else {
                return content + '...';
        ...
        getBlogList: function getBlogList() {
            ...
            if (this.more) {
                var blog_data = getBlogDataFunc(this.start, this.offset, this.now_category, this.now_tag, this.sort_by, this.search);
                ...
                try {
                    for (var _iterator = blog_data.blog_list[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        getBlogUrl: function getBlogUrl(blog_id) {
            return '/blog_detail/?blog_id=' + blog_id;
        },
        handleScroll: function handleScroll() {
            var scrollTop = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop;
            var offsetTop = document.querySelector(this.elFix).offsetTop;
        ...
        getBarFixedClass: function getBarFixedClass() {
        ...
        scroll: function scroll() {
            ...
            var isLoading = false;
            // 距离底部200px时加载一次
            var bottomOfWindow = document.documentElement.offsetHeight - document.documentElement.scrollTop - window.innerHeight <= diffHeight;
            if (this.more) {
...
function getBlogDataFunc(start, offset, category, tag, sort_by, search) {
    ...
    var op = {
        ...
        'success': function success(data) {
            ...
            console.log(_error3.responseJSON);
        }
    };
    $.ajax(op);
    return blog_data;
