...
const {getCookie} = __webpack_require__(1);
...
const { getCookie } = __webpack_require__(1)
const { checkUser, postComment } = __webpack_require__(2)
...
const {getCookie} = __webpack_require__(1)
const {my_blog_head, my_blog_comment} = __webpack_require__(7)
const {getUserMessage, GetQueryValue, slowScroll, handlePublishTimeDesc} = __webpack_require__(2)
